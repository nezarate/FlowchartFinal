...
/**
 * Represents the variable decoration lines on a Shapes.Rectangle object,
...
public class RectangleToolVariable extends RectangleTool{
    /**
     * Public constructor of the Shapes.RectangleToolVariable decoration
     * @param x1 The x coordinate of the center of this Shapes.Rectangle
     * @param y1 The y coordinate of the center of this Shapes.Rectangle
